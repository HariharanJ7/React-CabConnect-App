...
import { faPlaneDeparture , faPlaneArrival , faRoute } from '@fortawesome/free-solid-svg-icons';
    ...
    <Fragment>
      ...
      <div className="page-content header-clear-small">
        <Card
          ...
          type="inner"
          title={<div className="card-center ms-3"><h1 className="color-white mb-0">Driver Task</h1><p className="color-white mt-n1 mb-0">{CompletedTripValue}&nbsp;/&nbsp;{TotalTripValue} Tasks Completed</p></div>}
        ...
        >
            {LoaderTripData && 
              <div id="tripcard">
                {TripData.length === 0 ? (
                  <p>No trips available.</p> // Handle case where TripData is empty
                ) : (
                              ...
                              label: <Fragment>
                                <ListItem>
                                  <Row>
                                    ...
                                    <Col xs={19} sm={19} md={6} lg={7} xl={7} className="m-7px">
                                    ...
                                    <Col xs={24} sm={24} md={14} lg={16} xl={16} className="m-10px">
                                      <Stepper alternativeLabel activeStep={1} connector={<QontoConnectorBlue />}>
                                        <Step key={driverdata.pickuplocation}>
                                          <StepLabel StepIconComponent={StartIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.pickuplocation}</span></StepLabel>
                                        </Step>
                                        <Step key={driverdata.droplocation}>
                                          <StepLabel StepIconComponent={EndIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.droplocation}</span></StepLabel>
                                        </Step>
                                      </Stepper>
                                    </Col>
                                  </Row>
                            ...
                            items={[{ 
                              ...
                              label: <Fragment>
                                ...
                                <Row>
                                  ...
                                  <Col xs={19} sm={19} md={6} lg={7} xl={7} className="m-7px">
                                    <ListItemText primary={<span className="font-12 color-black"><LocalTaxiIcon className="font-13 mb-1 me-1" />{Number(driverdata.vehicleid) ? driverdata.vehiclemodel : driverdata.modelname }</span>} secondary={<span className="font-12 color-black"><CalendarMonthIcon className="font-13 mb-1 me-1"/>{moment(driverdata.tripdatetime).format('MMMM Do, YYYY')}</span>} />
                                  </Col>
                                  <Col xs={24} sm={24} md={14} lg={16} xl={16} className="m-10px">
                                    <Stepper alternativeLabel activeStep={1} connector={<QontoConnectorGreen />}>
                                      <Step key={driverdata.pickuplocation}>
                                        <StepLabel StepIconComponent={GreenStartIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.pickuplocation}</span></StepLabel>
                                      </Step>
                                      <Step key={driverdata.droplocation}>
                                        <StepLabel StepIconComponent={GreenEndIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.droplocation}</span></StepLabel>
                                      </Step>
                                    </Stepper>
                                  </Col>
                                  </Row>
                                  ...
                                  <Row>
                                    ...
                                    <Col xs={24} sm={24} md={14} lg={16} xl={16} className="m-10px">
                                      <Stepper alternativeLabel activeStep={1} connector={<QontoConnectorRed />}>
                                        <Step key={driverdata.pickuplocation}>
                                          <StepLabel StepIconComponent={RedStartIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.pickuplocation}</span></StepLabel>
                                        </Step>
                                        <Step key={driverdata.droplocation}>
                                          <StepLabel StepIconComponent={RedEndIcon}><span className="font-12 color-black"><LocationOnIcon className="font-13 mb-1 me-1"/>{driverdata.droplocation}</span></StepLabel>
                                        </Step>
                                      </Stepper>
                                    </Col>
                                  </Row>
